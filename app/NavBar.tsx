...
const NavBar = () => {
  ...
  return (
    <nav className='flex h-full flex-col'>
      ...
      <div className='mb-auto flex w-full items-center justify-center rounded-md bg-[#00A86B] px-4 py-2 text-white shadow-sm transition duration-200 hover:bg-[#008059] focus:outline-none focus:ring-2 focus:ring-[#00A86B] focus:ring-offset-2'>
